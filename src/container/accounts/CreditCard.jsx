...
const CreditCard = (props) => {
    ...
    return <div className='bankContainer'>
        ...
        <div className='listContainer credit availableCredit'><h2>{account.availableCredit >= 0 ? `$${props.addComma(account.availableCredit.toFixed(2))}` : `-$${Math.abs(props.addComma(account.availableCredit)).toFixed(2)}`}</h2></div>
